    ...
    <footer className="bg-primary border-t border-border py-16 text-white">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <h3 className="font-serif text-xl font-semibold mb-4">Sunflower School</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="pt-2">
                <Link href="tel:555-123-4567" className="hover:text-foreground transition-colors">
                  (555) 123-4567
                </Link>
              </li>
              <li>
                <Link href="mailto:info@oakwoodacademy.edu" className="hover:text-foreground transition-colors">
                  info@oakwoodacademy.edu
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-border text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Oakwood Academy. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
