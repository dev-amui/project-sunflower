...
import { OTPFormField, PhoneNumberFormField } from '@/customComponents/FormFields'
      ...
      <div className="relative w-full h-[250px] overflow-hidden mt-4">
        ...
        >
          <Form {...phoneNumberForm}>
            <form className="w-full flex flex-col gap-3" onSubmit={phoneNumberForm.handleSubmit(handleSubmit)}>
            ...
            <div className="login text-sm text-right mt-4 w-full">
              <span className="text-gray-400">Don't have an account? Click here to </span>
