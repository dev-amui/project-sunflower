...
const loginSchema = z.object({
  ...
  password: z
    .string()
    .min(6, "Password is required and must be atleast 6 characters"),
});
...
const AdminLoginPage = () => {
  ...
  const handleGoToDashboard = (data: any) => {
    console.log();
    router.push("/private/admin/applications/overview");
  };
    ...
    <div className="flex flex-col justify-center items-center w-[500px] mx-auto h-full">
      ...
      <Form {...loginForm}>
        <form
          ...
          onSubmit={loginForm.handleSubmit(handleGoToDashboard)}
        >
          <InputFormField
            form={loginForm}
            name="email"
