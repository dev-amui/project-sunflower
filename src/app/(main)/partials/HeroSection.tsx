  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src="/modern-school-building-exterior-with-students.jpg" alt="School campus" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        <p className="text-lg md:text-xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed">
          Where young minds flourish, character is built, and futures are shaped through innovative education and
